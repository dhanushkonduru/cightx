  ...
  return (
    <>
      ...
      <MapBand layers={[{ src: "suitability.png", on: true, smooth: true, opacity: 0.9 }]} overlay="zones" focus="top">
        <Reveal className="w-full">
          <div className="max-w-xl">
            ...
            <dl className="mt-10 grid max-w-md grid-cols-3 gap-4 border-t border-bone/15 pt-6">
              <div>
                <dd className="text-[clamp(1.3rem,2vw,1.8rem)] font-medium tracking-[-0.03em] text-bone">
                  +<Counter value={14417} />
                </dd>
                <dt className="mt-1 font-mono text-[10px] leading-snug text-bone/50">residents within 15 min</dt>
              </div>
              <div>
                <dd className="text-[clamp(1.3rem,2vw,1.8rem)] font-medium tracking-[-0.03em] text-bone">85–91%</dd>
                <dt className="mt-1 font-mono text-[10px] leading-snug text-bone/50">map accuracy</dt>
              </div>
              <div>
                <dd className="text-[clamp(1.3rem,2vw,1.8rem)] font-medium tracking-[-0.03em] text-bone">5</dd>
                <dt className="mt-1 font-mono text-[10px] leading-snug text-bone/50">ranked zones</dt>
              </div>
            </dl>
            <Link to={`/products/${flagship.slug}`} className="btn btn-primary mt-10">
              <span className="btn-dot" />
              Explore the Vellore deployment
            </Link>
          </div>
        </Reveal>
      </MapBand>
      ...
      >
        <Reveal className="w-full">
          <div className="max-w-xl">
            <p className="eyebrow">Vellore · 2013 → 2035</p>
            ...
            <p className="mt-6 flex flex-wrap items-baseline gap-x-6 gap-y-2 font-mono text-[12px] text-bone/60">
              <span><span className="text-[22px] text-bone">34.26</span> km² in 2013</span>
              <span><span className="text-[22px] text-laterite">47.47</span> km² by 2035</span>
            </p>
